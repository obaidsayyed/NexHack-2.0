...
import { sanitizeDepartment, sanitizeName, sanitizeOrganization } from '../utils/inputValidation';
          ...
          <form onSubmit={handleSave} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <Input
                ...
                value={hospitalName}
                maxLength={120}
                onChange={(e) => setHospitalName(sanitizeOrganization(e.target.value))}
              />
              ...
              <Input
                ...
                value={department}
                maxLength={80}
                onChange={(e) => setDepartment(sanitizeDepartment(e.target.value))}
              />
              ...
              <Input
                ...
                value={clinicianName}
                maxLength={80}
                onChange={(e) => setClinicianName(sanitizeName(e.target.value))}
              />
