          ...
          <div className="relative flex flex-col items-center sm:items-start min-h-[500px] justify-center">
             ...
             >
                <div className="flex items-baseline justify-center sm:justify-start gap-1">
                   <span className="text-[8rem] sm:text-[14rem] font-black tracking-tighter text-gradient leading-none">10-30</span>
                   <span className="text-6xl sm:text-8xl font-black text-primary">%</span>
                </div>
                <h3 className="text-2xl sm:text-4xl font-black mt-2">Fewer Readmissions(expected)</h3>
             </motion.div>
             ...
             <div className="w-full mt-16 sm:mt-0 relative sm:absolute sm:inset-0 pointer-events-none">
                ...
                >
                  ...
                  <p className="text-sm text-text-muted font-bold tracking-widest uppercase mt-2">Records Monitored</p>
                </motion.div>
                ...
                >
                  <p className="text-5xl sm:text-7xl font-black text-text-main">88.88%</p>
